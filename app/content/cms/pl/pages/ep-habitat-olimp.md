...
slots:
  aside:
    - type: static
      content: |
        ## Olimp
        - _Położenie_: kaldera [Olympus Mons](https://planetarynames.wr.usgs.gov/Feature/4453)
...
W szczytowym okresie populacja miasta wynosiła sześć milionów, jednak wraz z postępem terraformowania i poprawą warunków w innych rejonach, takich jak Valles Marineris, Argyre czy Hellas, wielu mieszkańców przeniosło się do bardziej sprzyjających osiedli. Dalszy spadek liczby ludności nastąpił w wyniku masowych ewakuacji podczas Upadku.

Ewakuacja, zorganizowana przez zarządzające miastem Olympus Infrastructure Authority (OIA), miała na celu zabezpieczenie infrastruktury po pojawieniu się doniesień o możliwości infekowania ludzi przez wirusy TITAN-ów. Z powodów politycznych i logistycznych wielu ewakuowanych nie zostało przyjętych przez inne duże miasta, takie jak Noctis czy Nowy Szanghaj. Zamiast tego zostali przesiedleni do tymczasowych obozów w regionach Amazonis i Tharsis, wykorzystujących nadmuchiwane kopuły i prefabrykowane moduły mieszkalne.
