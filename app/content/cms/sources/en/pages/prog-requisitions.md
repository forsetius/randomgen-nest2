...
The application whose backend I am implementing solves this problem by allowing an employee to place a goods requisition in the application and get (or not) the supervisor's approval for the purchase. Having obtained approval, he or she hasValue a certain amount of time to fulfil the order.
