...
slots:
  asideRight:
    - type: static
      content: |
        ## Grupy asteroidów
        - **[Apohele](https://pl.wikipedia.org/wiki/Grupa_Atiry)** (znane też jako **Atiry**) krążą całkowicie wewnątrz orbity Ziemi — ich [aphelium](https://pl.wikipedia.org/wiki/Aphelium) wynosi 0,983 AU lub mniej.
        - **[Ateny](https://pl.wikipedia.org/wiki/Grupa_Atena)** poruszają się głównie pomiędzy Ziemią a Słońcem. Wiele z nich ma jednak [ekscentryczne](https://pl.wikipedia.org/wiki/Ekscentryczno%C5%9B%C4%87_(fizyka)) orbity, przez co w punkcie aphelium czasami przecinają orbitę Ziemi.
  ...
  bottom:
    - type: pageGallery
      ...
      content: |
        Planetoidy bliskie [Ziemi]{pl/ep-atlas-ziemia} (NEA) to obiekty, które okrążają Słońce głównie wewnątrz orbity [Marsa]{pl/ep-atlas-mars}. Z definicji mają one średnicę większą niż 50 metrów (mniejsze obiekty klasyfikowane są jako meteory), a największe z nich osiągają szerokość do 34 kilometrów. Dzieli się je na kilka rodzin, w zależności od średniego promienia ich orbit, porównywanego do orbity Ziemi (1 AU). Ponieważ większość planetoid ma orbity [ekscentryczne](https://pl.wikipedia.org/wiki/Ekscentryczno%C5%9B%C4%87_(fizyka)) (bardziej eliptyczne niż kołowe), klasyfikacja ta nie zawsze precyzyjnie określa ich rzeczywiste położenie względem Ziemi czy innych ciał niebieskich.
    ...
    - type: pageGallery
      ...
      content: |
        [Trojańczycy](https://pl.wikipedia.org/wiki/Troja%C5%84czycy) Marsa to skupiska asteroidów krążące w [punktach Lagrange’a](https://pl.wikipedia.org/wiki/Punkt_libracyjny) L4 i L5 układu Mars–Słońce. Technicznie należą do grupy asteroidów typu Apollo. Choć nie są tak liczne jak trojańczycy [Jowisza]{pl/ep-atlas-jowisz} czy [Urana]{pl/ep-atlas-uran}, wciąż liczą się w setkach. Znajdują się tam także dziesiątki [habitatów]{pl/ep-habitat}.
