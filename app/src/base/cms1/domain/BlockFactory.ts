...
export class BlockFactory {
  ...
  public create(def: BlockDef, locale: Locale): Block {
    switch (def.type) {
      ...
      case BlockType.PAGE:
        return new PageBlock(this.templatingService, def, locale);
      case BlockType.PAGE_LIST:
        return new PageListBlock(this.templatingService, def, locale);
      case BlockType.PAGE_SET:
        return new PageSetBlock(this.templatingService, def, locale);
      ...
      case BlockType.TAG:
        return new TagBlock(this.templatingService, def, locale);
    }
  }
}
